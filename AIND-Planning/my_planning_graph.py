...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        # 	if any(e in node_a2.action.ineffect_rem):
        # 		return True
        # return False

        return bool(set(node_a1.action.precond_pos) & set(node_a2.action.effect_rem) |
                    set(node_a2.action.precond_pos) & set(node_a1.action.effect_rem) )
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return bool(set(node_a1.action.effect_add) & set(node_a2.action.precond_neg) |
        			set(node_a2.action.effect_add) & set(node_a1.action.precond_neg) |
        			set(node_a1.action.precond_pos) & set(node_a2.action.effect_rem) |
        			set(node_a2.action.precond_pos) & set(node_a1.action.effect_rem) )
